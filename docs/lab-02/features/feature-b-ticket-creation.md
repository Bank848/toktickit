...
**Traceability.** FR-06…FR-12 · BR-01, BR-02, BR-06, BR-10, BR-11 ·
NFR-01, NFR-02, NFR-03 · D-03, D-10, D-13, D-16, D-18.
...
-> client then uploads each staged file, in sequence, against the new ticket's id (FR-11,
...
the Attachments section (see Feature-F). Acceptance: a created ticket has status NEW, ownerId null,
...
**NFRs.** p95 < 500ms (create-ticket call; attachment uploads excluded per SDS) (NFR-01); WCAG 2.2
AA form labelling (NFR-02); double-submit disabled while in flight; Zen Green theme (NFR-03).
**Dependencies.** Seeded categories, related systems, Feature-G (Development Requester
...
Development Requester Selection screen (Feature-G).
