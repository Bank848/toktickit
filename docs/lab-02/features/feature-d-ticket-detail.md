...
**Traceability.** FR-18, FR-19 (spec §4) · NFR-03, NFR-07 · D-13, D-14, D-15, D-16, D-21, D-22.
...
`ticket.requesterId === req.user.id`, else 403 (not 404, to avoid confirming existence). There is
no second branch for any other kind of caller — Lab 2 has no role-based access control (D-21).
...
**NFRs.** WCAG 2.2 AA; localized timestamps stored in UTC (NFR-07); Zen Green theme (NFR-08).
