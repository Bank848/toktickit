...
| E2E-04 | E2E | AC-25, AC-26, AC-27, AC-28, AC-29, AC-30 | Full admin journey: log in as Administrator, create a user, attempt a duplicate-email create (rejected), edit the created user, reset their password, attempt self-deactivation (rejected), create a second admin then deactivate it to become the sole active admin and attempt to change own role away from Administrator (rejected), and finally deactivate the newly created user | Every step succeeds/fails exactly as specified, at desktop and mobile viewports | `e2e/lab-03/user-administration.spec.ts` |
