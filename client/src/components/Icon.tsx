...
const PATHS: Record<string, string> = {
  ...
  pencil:
    'M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.5 2.207 1.793 9.914a.5.5 0 0 0-.128.221l-1.5 5a.5.5 0 0 0 .622.622l5-1.5a.5.5 0 0 0 .221-.128z',
};
